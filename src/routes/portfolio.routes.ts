...
// Rotta per la creazione di un album (accetta file + altri campi)
router.post('/', upload.any(), addPortfolioItem);

// Rotta per l’aggiornamento di un album (accetta file + altri campi)
router.put('/:id', upload.any(), updatePortfolioItem);
